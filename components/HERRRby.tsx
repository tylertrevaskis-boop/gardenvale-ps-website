export default function HERRRby() {
  const values = [{title:'Honesty',description:'Being truthful with yourself and others'},{title:'Empathy',description:'A sincere attempt to understand someone else\'s feelings'},{title:'Resilience',description:'The ability to bounce back'},{title:'Respect',description:'Treat everyone as you would like to be treated'},{title:'Responsibility',description:'Taking appropriate action when required'},{title:'Be Yourself',description:'Embrace your unique strengths and identity'}];
  return (
    <section style={{backgroundColor:'#003D5C',padding:'5rem 0'}}>
      <div style={{maxWidth:'1280px',margin:'0 auto',padding:'0 1.5rem'}}>
        <div style={{display:'grid',gridTemplateColumns:'1fr auto',gap:'3rem',alignItems:'center',marginBottom:'3rem'}}>
          <div>
